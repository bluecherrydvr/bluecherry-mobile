...
export function reducer(state, action) {
    switch (action.type) {
        case 'login':
            return {...initialState, activeAccount: action.payload, targetDevice: action.targetDevice};
        case 'logout':
            return {...initialState};
        ...
        case 'update_all_device_list':
            return {...state, deviceList: action.deviceList, selectedDeviceList: action.selectedDeviceList};
    }
}
